  ...
  <main class="d-flex flex-nowrap">
    <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
      ...
      <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li>
          <a href="./config/r.php" class="nav-link text-white">
            <svg class="bi pe-none me-2" width="16" height="16">
        ...
        <li>
          <a href="./config/hr.php" class="nav-link text-white">
            <svg class="bi pe-none me-2" width="16" height="16">
        ...
        <li>
          <a href="./config/produit.php" class="nav-link text-white">
            <svg class="bi pe-none me-2" width="16" height="16">
              <use xlink:href="#grid" />
            </svg>
            Products
        ...
        <li>
          <a href="./config/setting" class="nav-link text-white">
            <svg class="bi pe-none me-2" width="16" height="16">
      ...
      <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-dark text-small shadow">
          <li><a class="dropdown-item" href="./config/setting/">Paramètre</a></li>
          <li><a class="dropdown-item " href="./config/hr.php">Historique</a></li>
          <li><a class="dropdown-item text-danger" href="./config/decon.php">Déconnexion</a></li>
        </ul>
      </div>
    </div>
    ...
    <div class="container mt-5">
      ...
      <h1 class="display-1 text-center text-primary mb-1"><u>Choisir un type de requête :</u> </h1>
