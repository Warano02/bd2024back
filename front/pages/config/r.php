...
<body>
  ...
  <main class="d-flex flex-nowrap">
    ...
    <div class="container mt-5 ">
      <form id="form">
        <fieldset>
          <legend>Remplie les informations pour la requête :</legend>
          <div class="mb-3">
            <label for="disabledTextInput" class="form-label">Code UE:</label>
            <input type="text" id="disabledTextInput" class="form-control" placeholder="INF225" required>
          </div>
          <div class="mb-3">
            <label for="disabledTextInput2" class="form-label">Objet de la requête:</label>
            <input type="text" id="disabledTextInput2" class="form-control" placeholder="Blocage de matricule " required>
          </div>
          <div class="mb-3">
            <label for="disabledSelect" class="form-label">Sélectionnez la filière</label>
          ...
          <div class="mb-3">
            <div class="form-check">
              ...
              <label class="form-check-label" for="disabledFieldsetCheck">
                Ces informations sont ils corrects?
              </label>
            </div>
          </div>
