...
<head>
    ...
    <title>Historique de Requête - GP5_BD</title>
...
<body>
    ...
    <main class="d-flex flex-nowrap">
        ...
        <div class="container mt-5">
            <h2 class="display-3 text-center text-secondary mb-4"><u>Historique de Requête</u> </h2>
            ...
            <table class="table  table-bordered table-striped">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Type de Requête</th>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="staticBackdropLabel">Supprimer la requête :</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            En cliquant sur Supprimer ci-dessous, vous allez <span class="text-danger">supprimer définitivement</span> votre requête avec <span id="id" class="text-danger">002</span> et donc elle ne pourras plus être traiter. est bien ce que vous voulez?
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Annuler</button>
                            <button type="button" class="btn btn-danger" id="sup">Supprimer</button>
                        </div>
                    </div>
                </div>
            </div>
